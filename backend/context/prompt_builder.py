    ...
    def build(
        ...
        *,
        ...
        return (
            ...
            "向用户询问或最终回复时只输出可见答复，不得输出思考过程、推理草稿、"
            "<think>、<thinking>、<reasoning> 或 <analysis> 内容。"
            ...
            "create_plan 只表达 Skill 之间的依赖；同一个 gis-pipeline 的内部 GIS 操作必须放在一个计划步骤中，"
            "不得拆成多个同 Skill 步骤，也不得增加用户原始请求未要求的统计、面积、占比或验证交付物。\n\n"
